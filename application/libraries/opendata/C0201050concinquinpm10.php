...
class C0201050concinquinpm10 extends CsvOpenData {
    ...
    public function __construct() {
        parent::__construct("http://dati.veneto.it/dataset/64fcb822-2ca1-4e41-bea2-21437f445573/resource/3c54cd61-a537-456d-925f-ad385049d16d/download/c0201050concinquinpm10.csv", 3);
    }
    ...
    public function custom_parse() {
        ...
        foreach ($array as $key => $riga) {
            if ((!isset($riga[2])) || (!isset($riga[3])) || $riga[2] == "-" || $riga[3] == "-") {
                ...
                $array[$key][4] = intval($riga[2]) + 50 * intval($riga[3]);
            }
        }
